...
export default async function Home() {
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-100 selection:bg-emerald-500/30 overflow-x-hidden">
      ...
      {/* أزلنا الحاوية الضيقة من الـ main لكي يأخذ الموقع حريته */}
      <main className="w-full">
        
        {/* --- القسم الرئيسي (Hero) مغلف بـ max-w-5xl للترتيب --- */}
        ...
        {/* --- قسم التواصل (مقيد بالحدود) --- */}
        <section id="contact" className="max-w-5xl mx-auto px-6 py-24 border-t border-zinc-900 text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Link href="https://wa.me/963938457732" target="_blank" className="bg-[#25D366]/10 text-[#25D366] border border-[#25D366]/20 hover:bg-[#25D366]/20 px-6 py-4 rounded-2xl font-bold flex items-center gap-3 transition-colors">
              <WhatsAppIcon size={24} /> واتساب
            </Link>
            <Link href="https://t.me/+963938457732" target="_blank" className="bg-[#229ED9]/10 text-[#229ED9] border border-[#229ED9]/20 hover:bg-[#229ED9]/20 px-6 py-4 rounded-2xl font-bold flex items-center gap-3 transition-colors">
        ...
        <footer className="max-w-5xl mx-auto px-6 py-8 border-t border-zinc-900 flex flex-col md:flex-row justify-between items-center gap-4 text-zinc-500 text-sm">
